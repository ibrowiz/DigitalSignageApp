...
class LayoutTemplateController extends Controller
{
	...
	public function __construct() 
	{
 	...
 	public function index(Request $request){
    	...
    	return view('app.mediapartner.layout-template.index', ['templates'=>$templates]);
    }
    ...
    public function Create(Request $request){
        ...
        return view('app.mediapartner.layout-template.home', ['resources'=>$resources, 'contents'=>$contents]);
    }
	...
	public function edit($domain,$id){
        ...
        return view('app.mediapartner.layout-template.edit', ['resources'=>$resources, 'contents'=>$contents, 'template'=>$template]);
    }

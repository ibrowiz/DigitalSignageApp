...
@section('content')
	...
	<div>
        <a href="{{URL::to('admin/layouttemplates/create')}}">
	...
	<div>
		@foreach($templates as $template)
			...
			<a href= '{{url("admin/layouttemplates/delete/{$template->id}")}}'> <i class="fa fa-trash"></i> </a>
			 <img src="{{$template->image}}" class="img img-rounded" style="width: 350px; height: 300px;"> 

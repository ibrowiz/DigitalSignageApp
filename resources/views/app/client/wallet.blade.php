...
<!-- Spacer Starts -->
          <div class="spacer">
            ...
            <!-- <a href='#' class = "btn btn-warning btn-rounded btn-transparent" data-id=" " data-toggle="modal" data-url="" data-target="#changesettings">Settings</a> -->

            <a href='#' class = "btn btn-warning btn-rounded btn-transparent" data-id="{{$wallet->client_profile_id}}" data-toggle="modal" data-url="{{url('client/'.$tenant->domain.'/walletsetting')}}" data-target="#changesettings">Settings</a> 

             <!-- <a href='#' class = "btn btn-success btn-rounded btn-transparent" data-id="" data-toggle="modal" data-url="" data-target="#bonus">Convert Bonus</a> -->

              <a href='#' class = "btn btn-success btn-rounded btn-transparent" data-id="{{$wallet->clientProfile->client->id}}" data-toggle="modal" data-url="{{url('client/'.$tenant->domain.'/wallet/convertbonus/'.$wallet->clientProfile->client->id)}}" data-target="#bonus">Convert Bonus</a>

              <!-- <a href="" class = "btn btn-info btn-rounded btn-transparent">Make Payment</a> -->

              <a href="{{url('client/'.$tenant->domain.'/payment/index')}}" class = "btn btn-info btn-rounded btn-transparent">Make Payment</a>

              <!-- <a href='#' class = "btn btn-danger btn-rounded btn-transparent" data-id="" data-toggle="modal" data-url="" data-target="#credit">Buy Points</a> --> 
               <a href='#' class = "btn btn-danger btn-rounded btn-transparent" data-id="{{$wallet->clientProfile->client->id}}" data-toggle="modal" data-url="{{url('client/'.$tenant->domain.'/wallet/assignpoint/'.$wallet->clientProfile->client->id)}}" data-target="#credit">Buy Points</a>

                  ...
                  <div class="table-responsive">
                        ...
                        <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                <a href='#' class = "btn btn-danger btn-xs" data-id="{{$payPendActvn->id}}" data-toggle="modal" data-url="{{url('/contentowner/payment/delete/'. $payPendActvn->id)}}" data-target="#delete">Delete</a>
                                </td>
                            </tr>
                            @endforeach
                    </table>

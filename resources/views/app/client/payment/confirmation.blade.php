                    ...
                    <div class="panel-group">
                     <div class="panel panel-default">
                      <div class="panel-heading">WEBPAY</div>
                        ...
                        {{ csrf_field() }}
                            ...
                            <h4><span class="glyphicon glyphicon-pushpin"></span>
                                ...
                                You are paying : <p>(<span
                                        style="color:#F00"><span>&#8358;</span>{{$amount_naira}}</span>)</p>
                            </h4>
                        <fieldset>
                        ...
                        <input name="cust_name" type="hidden" value="{{Auth::user()->client->name}}">
                        <input name="cust_id" type="hidden" value="{{Auth::user()->client->id}}">

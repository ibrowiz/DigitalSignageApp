...
@section('content')
	...
	<div>
        <a href="{{URL::to('client/'.$tenant->domain.'/layouttemplates/create')}}">
	...
	<div>
		@foreach($templates as $template)
			...
			<span class="thumbnail" style="display: inline-block; padding: 5px; "> <img src="{{$template->image}}" class="img img-rounded" style="width: 350px; height: 300px;"> 
				 <a href='{{url("client/{$tenant->domain}/layouttemplates/edit/{$template->id}")}}' class = "fa fa-pencil-square-o">{{$template->file_name}} </a>
			</span>

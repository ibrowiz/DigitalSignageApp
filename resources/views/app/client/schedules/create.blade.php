...
<div class="row " style="">
	...
	<div class="blog">
    	...
    	<!-- First Step -->
    	<form role="form" action='{{url("client/{$tenant->domain}/schedule/save")}}' method="post" id="scheduleForm">
...
<script type="text/javascript">
	...
	var url = '{{route("client.user.layouts.search",[$tenant->domain])}}';
	var url_devices = '{{route("client.user.devices.search",[$tenant->domain])}}';

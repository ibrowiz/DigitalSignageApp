@extends('layouts.contentowner.fileMaster')
...
$('#save-canvas').on('click', function(evt){
  ...
  var url = "{{url('client/'.$tenant->domain.'/layout/edit/'.$layout->id)}}";//{{url("view", $layout->id)}}
  ...
  $.ajax({
      ...
      success:function(data){
          window.location="{{url('client/'.$tenant->domain.'/layout/welcome')}}";

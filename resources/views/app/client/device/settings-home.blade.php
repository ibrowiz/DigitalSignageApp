    ...
    <div class="row">
		...
		<div class="row">
		  <div class="col-lg-12 col-md-12 col-sx-12 col-sm-12">
			...
			<div class="panel-body">
		<form class="form-horizontal" role="form"  method="POST" action="{{ url('client/'.$tenant->domain.'/device/applytemplate')}}">
		{{ csrf_field() }}
	  ...
	  <div class = "spacer">
	   <div class="row">
		 <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		  ...
		  <form class="form-horizontal" role="form"  method="POST" action="{{ route('client.user.device.updatesettings',[$tenant->domain,$device->id])}}">
			{{ csrf_field() }}

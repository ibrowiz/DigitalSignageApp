              ...
              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="blog">
                  <div class="blog-header">
                    <h5 class="blog-title">Edit Business Type</h5>
                  </div>
                  <div class="blog-body">
                    <form class="form-horizontal" role="form"  method="POST" action="{{url('admin/businesstype/update',array($businessType->id))}}">
                    {{ csrf_field() }}
                          ...
                          <div class="col-xs-10 col-sm-5">
                            ...
                            <option value = " ">Select</option>
                              @foreach($businessCategories as $businessCategory)
                                <option {{ $businessType->business_category_id == $businessCategory->id ? "selected":"" }} value="{{$businessCategory->id}}">{{$businessCategory->category_name}}</option>
                              @endforeach
                            </select>
                          </div>
                        </div>

...
@section('content')
	...
	<div class="row">
		...
		<div class="col-md-12">
			...
			<form action="{{ url('mediapartner/'.$tenant->domain.'/resource/upload') }}" class="dropdone" id="file-upload" method="post" enctype="multipart/form-data">
			  	{{ csrf_field() }}
			...
			@foreach($resources as $resource)
				...
				<div class="col-md-2">
					<span class="thumbnail" style="display: inline-block; padding: 5px;" >
						<a href= '{{url("mediapartner/{$tenant->domain}/resource/delete/{$resource->id}")}}'> <i class="fa fa-trash"></i> </a>

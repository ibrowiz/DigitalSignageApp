                              ...
                              <th>Assign</th>
                               ...
                               @foreach($contentOwners as $contentOwner)
                                   <tr>
                                      ...
                                      <td> <a href='#' class = "btn btn-success btn-xs" data-id="{{--{{$contentOwner->id}}--}}" data-toggle="modal" data-url="{{url('mediapartner/contentowner/credit/assign/'. $contentOwner->id)}}" data-target="#credit">Credit Wallet</a> 
                                    </td>
                                    </tr>

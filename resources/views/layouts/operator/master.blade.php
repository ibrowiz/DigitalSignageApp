...
<head>
	...
	<link href="{{ URL::to('css/chkbox.css')}}" rel="stylesheet" media="screen">
...
{{--     <script src="{{URL::to('js/moment.min.js')}}"></script>
    ...
    <script type="text/javascript" src="{{url('js/formats.js')}}"></script> 
	...
	<body>
		...
		<!-- Left sidebar starts -->
		@include('layouts.mediapartner.sidebar')
		<!-- Left sidebar ends -->
